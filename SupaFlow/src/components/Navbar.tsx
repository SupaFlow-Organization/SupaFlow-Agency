...
export default function Navbar({ navRef }: NavbarProps) {
  ...
  return (
    <nav
      ...
      className={`fixed top-0 left-0 w-full z-40 transition-all duration-300 py-4 sm:py-6 flex justify-between items-center px-5 sm:px-8 lg:px-12 ${menuOpen ? 'bg-white' : ''}`}
    >
      <a
        href="#"
      ...
      <div className="flex items-center gap-3 z-10">
        ...
        {isMobile && (
          <button
            ...
            className="w-10 h-10 flex flex-col items-center justify-center gap-1.5 rounded-full border border-black/10"
      ...
      <AnimatePresence>
        {isMobile && menuOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 w-full bg-white/98 backdrop-blur-2xl border-b border-black/5 shadow-[0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden"
          >
            <motion.div
